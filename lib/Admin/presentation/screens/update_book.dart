              ...
              child: ListView(
                children: [
                  CustomTextFormField(
                    ...
                    BlocProvider.of<AdminCubit>(context).updateBookTitle,
                    name: "Book title",
                  ),
                  CustomTextFormField(
                    textEditingController:
                    BlocProvider.of<AdminCubit>(context).updateBookCategories,
                    name: "Book categories",
                  ),
                  CustomTextFormField(
                    textEditingController:
                    BlocProvider.of<AdminCubit>(context).updateBookAuthors,
                    name: "Book authors",
                  ),
                  CustomTextFormField(
                    textEditingController:
                    BlocProvider.of<AdminCubit>(context).updateBookDescription,
                    name: "Book description",
                  ),
                  CustomTextFormField(
                    textEditingController:
                    BlocProvider.of<AdminCubit>(context).updateBookPublishYear,
                    name: "Book published year",
                  ),
                  CustomTextFormField(
                    textEditingController:
                    BlocProvider.of<AdminCubit>(context).updateBookAverageRating,
                    name: "Book average rating",
                  ),
                  CustomTextFormField(
                    textEditingController:
                    BlocProvider.of<AdminCubit>(context).updateBookRatingCount,
                    name: "Book ratings count",
                  ),
                  CustomTextFormField(
                    textEditingController:
                    BlocProvider.of<AdminCubit>(context).updateBookNumPage,
                    name: "num page",
                  ),
                  CustomTextFormField(
                    textEditingController:
                    BlocProvider.of<AdminCubit>(context).updateBookURL,
                    name: "URL",
                  ),
                  SizedBox(
                    height: 4.h,
                  ...
                  ElevatedButton(
                    onPressed: () async{
                      ...
                      //getData2();
                      BlocProvider.of<AdminCubit>(context).updateBook();
