...
class BookListSection extends StatelessWidget {
  ...
  BookListSection({super.key, required this.numberOfElement,required this.allowPhysics});
      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextButton(onPressed: () {
              Navigator.of(context).pushNamed(Routers.allBook);
        ...
        BlocListener<AdminCubit,AdminState>(
          ...
          child: ListView.builder(
            ...
            physics: allowPhysics == false ? const NeverScrollableScrollPhysics() : const ScrollPhysics(),
            ...
            itemBuilder: (context, index) {
              return ListTile(
                ...
                leading: ClipRRect(
                  ...
                  child: Image.network(
                    BlocProvider.of<AppCubit>(context).allBook[index].urlImage,
                    height: 15.h,
                    width: 7.h,
                    fit: BoxFit.cover,
                  ),
                ...
                title: Text(
                  BlocProvider.of<AppCubit>(context).allBook[index].title,
                  style: TextStyle(
                    fontSize: 16.sp,
                ...
                subtitle: Text(
                  BlocProvider.of<AppCubit>(context).allBook[index].author, // Assuming there's an author field
                  style: TextStyle(
                    fontSize: 12.sp,
                  ...
                  itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                    ...
                    PopupMenuItem<String>(
                      onTap: () {
                        ...
                        BlocProvider.of<AdminCubit>(context).id = BlocProvider.of<AppCubit>(context).allBook[index].id.toString();
                        print("i am here");
                        print(BlocProvider.of<AdminCubit>(context).id!);
                      },
                      value: 'Update',
